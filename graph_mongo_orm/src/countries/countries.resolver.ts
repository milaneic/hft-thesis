...
export class CountriesResolver {
  ...
  vehicles(
    ...
    return vehiclesByCountryLoader.load(country._id.toString());
  }
  ...
  ordersAsOrigin(
    ...
    return ordersByOriginCountryLoader.load(country._id.toString());
  }

  @ResolveField(() => [Order])
  ordersAsDestination(
    @Parent() country: Country,
    @Context('ordersByDestiantionCountryLoader')
    ordersByDestiantionCountryLoader: DataLoader<string, Order>,
  ) {
    return ordersByDestiantionCountryLoader.load(country._id.toString());
  }
}
